...
const displayName = GLOBAL_HEADER;
	...
	return (
		<header className="slds-global-header_container">
			{props.onSkipToNav ? (
				...
				>
					{props.skipToNavAssistiveText || assistiveText.skipToNav}
				</a>
			) : null}
			{props.onSkipToContent ? (
				<a
					href="javascript:void(0);"
					className="slds-assistive-text slds-assistive-text_focus"
					onClick={handleSkipToContent}
				>
					{props.skipToContentAssistiveText || assistiveText.skipToContent}
				</a>
			) : null}
