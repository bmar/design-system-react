...
const defaultProps = { assistiveText: { icon: 'Open menu item submenu' } };

/**
 *  The Dropdown Button Trigger renders the default trigger button for the dropdown menu. If this component has children, it does not render itself to the DOM. Instead, it renders its child element, `Button`, and all that child's properties. This component may be used as a template to create custom triggers that do not use `Button`.
 */
const GlobalNavigationDropdownTrigger = (props) => {
...
GlobalNavigationDropdownTrigger.defaultProps = defaultProps;
GlobalNavigationDropdownTrigger.propTypes = propTypes;
GlobalNavigationDropdownTrigger.displayName = displayName;
